    ...
    <div class="evento__informacion">
        ...
        <div class="evento__autor-info">
            <picture>
                ...
                <img class="evento__imagen-autor" loading="lazy" width="200" height="300" src="<?php echo $_ENV['HOST'] . '/img/speakers/' . $evento->ponente->imagen; ?>.png" alt="Imagen evento->ponente">
            </picture>
            <p class="evento__nombre-autor"><?php echo $evento->ponente->nombre . " " . $evento->ponente->apellido; ?></p>
