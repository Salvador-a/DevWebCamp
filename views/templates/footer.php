<footer class="footer">
    <div class="footer__grid">
        <div class="footer__contenido">
            ...
            <p class="footer__texto">
                DevWebCamp es una conferencia de desarrolladores de todos loa niveles, de forma presencial y en línea.
            </p>
        </div>
        <nav class="menu-redes"> 
            ...
            <a class="menu-redes__enlace" rel="noopener noreferrer" target="_blank" href="h">
    ...
    <p class="footer__copyright">
        DevWebCamp
        <span class="footer__copyriht--regular">
